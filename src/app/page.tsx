...
export default async function Home() {
  ...
  return (<>
   <main className="mx-auto max-sm:w-[95%] w-[80%] fontPoppins text-center py-7 ">
      <h1 className=" text-5xl mb-7 text-sky-800 fontRoboto font-extrabold max-sm:text-3xl">No-Big-url</h1>
  ...
  <div className={` fontPoppins flex flex-col  bg-gray-400 h-20 w-full max-sm:text-sm`} >
